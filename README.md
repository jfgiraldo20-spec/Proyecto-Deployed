...
° Exploración fácil: navegación mediante un menú intuitivo.
° Modo oscuro funcional en toda la página, almacenado con localStorage.
...
° Secciones del sitio Página principal (index.html)

-Banner o presentación inicial
-Catálogo o productos destacados
-Botones de navegación
-Sección informativa o promocional
-Página Sobre nosotros (sobre.html)
-Historia o propósito de la marca
-Qué ofrece MotoParts Pro
-Valores y misión
